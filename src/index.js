import world from './js/world-controller/worldController';
import stats from './js/stats-controllers/statsController'
import airplane from './js/airplaneController';
import parachuteController from './js/parachute-controller/parachuteController';
...
const gameController = (() => {
  ...
  function resetGame() {
    ...
    world.resetWorld();
    stats.resetStats();
    parachuteController.resetParachutes();
